	...
	public class ProgressBar extends FeathersControl
	{
		...
		protected function layoutChildren():void
		{
			...
			if (this._direction == DIRECTION_VERTICAL)
			{
				...
				this.currentFill.height = Math.round(
						this._originalFillHeight + percentage * (this.actualHeight - this._paddingTop
																 - this._paddingBottom - this._originalFillHeight)
				);
			...
			{
				this.currentFill.width = Math.round(
						this._originalFillWidth + percentage * (this.actualWidth - this._paddingLeft
																- this._paddingRight - this._originalFillWidth)
				);
