	 ...
	 */ public class SimpleScrollBar extends FeathersControl implements IDirectionalScrollBar
	{
		...
		protected function autoSizeIfNeeded():Boolean
		{
			if (this.thumbOriginalWidth !== this.thumbOriginalWidth || this.thumbOriginalHeight
																	   !== this.thumbOriginalHeight) //isNaN
			{
				this.thumb.validate();
		...
		protected function locationToValue(location:Point):Number
		{
			...
			if (this._direction == DIRECTION_VERTICAL)
			{
				var trackScrollableHeight:Number = this.actualHeight - this.thumb.height - this._paddingTop
												   - this._paddingBottom;
			...
			{
				var trackScrollableWidth:Number = this.actualWidth - this.thumb.width - this._paddingLeft
												  - this._paddingRight;
