...
package feathers.controls
{
	 ...
	 */ public class TabBar extends FeathersControl implements IFocusDisplayObject
	{
		...
		private static const DEFAULT_TAB_FIELDS:Vector.<String> = new <String>
				[
					"defaultIcon", "upIcon", "downIcon", "hoverIcon", "disabledIcon", "defaultSelectedIcon",
					"selectedUpIcon", "selectedDownIcon", "selectedHoverIcon", "selectedDisabledIcon", "isEnabled"
				];
		...
		protected function refreshLayoutStyles():void
		{
			if (this._direction == DIRECTION_VERTICAL)
			{
				...
				this.verticalLayout.verticalAlign =
						(this._verticalAlign == VERTICAL_ALIGN_JUSTIFY) ? VERTICAL_ALIGN_TOP : this._verticalAlign;
			...
			else //horizontal
			{
				...
				this.horizontalLayout.horizontalAlign =
						(this._horizontalAlign == HORIZONTAL_ALIGN_JUSTIFY) ? HORIZONTAL_ALIGN_LEFT :
