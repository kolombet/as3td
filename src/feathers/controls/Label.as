	...
	public class Label extends FeathersControl implements ITextBaselineControl
	{
		...
		protected function autoSizeIfNeeded():Boolean
		{
			...
			if (needsWidth)
			{
				...
				if (this.originalBackgroundWidth === this.originalBackgroundWidth && this.originalBackgroundWidth
																					 > newWidth) //!isNaN
				{
			...
			if (needsHeight)
			{
				...
				if (this.originalBackgroundHeight === this.originalBackgroundHeight && this.originalBackgroundHeight
																					   > newHeight) //!isNaN
				{
		...
		protected function createTextRenderer():void
		{
			...
			var factory:Function = this._textRendererFactory != null ? this._textRendererFactory :
