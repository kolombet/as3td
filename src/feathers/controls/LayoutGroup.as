...
package feathers.controls
{
	...
	public class LayoutGroup extends FeathersControl
	{
		...
		protected function refreshBackgroundSkin():void
		{
			...
			if (this.currentBackgroundSkin)
			{
				if (this.originalBackgroundWidth !== this.originalBackgroundWidth || this.originalBackgroundHeight
																					 !== this.originalBackgroundHeight) //isNaN
				{
		...
		protected function handleLayoutResult():void
		{
			this.setSizeInternal(
					this._layoutResult.viewPortWidth, this._layoutResult.viewPortHeight, false
			);
		}
