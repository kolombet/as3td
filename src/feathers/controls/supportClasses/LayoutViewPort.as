...
package feathers.controls.supportClasses
{
	...
	public class LayoutViewPort extends LayoutGroup implements IViewPort
	{
		...
		{
			if (this._explicitVisibleWidth == value || (value !== value && this._explicitVisibleWidth
																		   !== this._explicitVisibleWidth)) //isNaN
			{
				return;
			}
		...
		{
			if (this._explicitVisibleHeight == value || (value !== value && this._explicitVisibleHeight
																			!== this._explicitVisibleHeight)) //isNaN
			{
				return;
			}
		...
		override protected function refreshViewPortBounds():void
		{
			...
			if (this._autoSizeMode == AUTO_SIZE_MODE_STAGE && this._explicitVisibleHeight
		...
		override protected function handleLayoutResult():void
		{
			this.setSizeInternal(
					this._layoutResult.contentWidth, this._layoutResult.contentHeight, false
			);
