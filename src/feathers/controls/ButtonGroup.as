	 ...
	 */ public class ButtonGroup extends FeathersControl
	{
		...
		private static const DEFAULT_BUTTON_FIELDS:Vector.<String> = new <String>
				[
					...
					"selectedUpIcon", "selectedDownIcon", "selectedHoverIcon", "selectedDisabledIcon", "isSelected",
					"isToggle", "isLongPressEnabled",
				];
		...
		protected function createFirstButton(item:Object):Button
		{
			...
			{
				isNewInstance = true;
				var factory:Function = this._firstButtonFactory != null ? this._firstButtonFactory :
									   this._buttonFactory;
