	...
	public class Panel extends ScrollContainer implements IFocusExtras
	{
		...
		override protected function autoSizeIfNeeded():Boolean
		{
			...
			if (needsWidth)
			{
				newWidth = Math.max(
						this.header.width,
						this._viewPort.width + this._rightViewPortOffset + this._leftViewPortOffset
				);
				if (this.footer)
				{
		...
		protected function createHeader():void
		{
			...
			var headerStyleName:String = this._customHeaderStyleName != null ? this._customHeaderStyleName :
										 this.headerStyleName;
		...
		protected function createFooter():void
		{
			...
			var footerStyleName:String = this._customFooterStyleName != null ? this._customFooterStyleName :
										 this.footerStyleName;
