	...
	public class OldFadeNewSlideTransitionManager
	{
		...
		protected function onTransition(oldScreen:DisplayObject, newScreen:DisplayObject, onComplete:Function):void
		{
			...
			if (oldScreen)
			{
				...
				{
					this._crossfadeTransition =
							Fade.createCrossfadeTransition(this._duration, this._ease, {delay: this._delay});
				}
			...
			if (stackIndex < 0) //push
			{
				...
				{
					this._pushSlideTransition =
							Slide.createSlideLeftTransition(this._duration, this._ease, {delay: this._delay});
				}
			...
			else //pop
			{
				...
				{
					this._popSlideTransition =
							Slide.createSlideRightTransition(this._duration, this._ease, {delay: this._delay});
				}
