...
package feathers.media
{
	 ...
	 */ public class MuteToggleButton extends ToggleButton implements IMediaPlayerControl
	{
		...
		public function set mediaPlayer(value:IMediaPlayer):void
		{
			...
			if (this._mediaPlayer)
			{
				this._mediaPlayer.addEventListener(
						MediaPlayerEventType.SOUND_TRANSFORM_CHANGE,
						mediaPlayer_soundTransformChangeHandler
				);
			}
		...
		protected function createVolumeSlider():void
		{
			...
			var factory:Function = this._volumeSliderFactory != null ? this._volumeSliderFactory :
								   defaultVolumeSliderFactory;
			var volumeSliderStyleName:String = this._customVolumeSliderStyleName != null ?
											   this._customVolumeSliderStyleName : this.volumeSliderStyleName;
