...
package feathers.media
{
	 ...
	 */ public class VideoPlayer extends BaseTimedMediaPlayer implements IVideoPlayer, IProgressiveMediaPlayer
	{
		...
		override protected function playMedia():void
		{
			...
			if (!this._netStream)
			{
				var netConnectionFactory:Function = this._netConnectionFactory !== null ? this._netConnectionFactory :
													defaultNetConnectionFactory;
			...
			else
			{
				...
				this._texture =
						Texture.fromNetStream(this._netStream, Starling.current.contentScaleFactor, onCompleteCallback);
