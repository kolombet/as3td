...
package feathers.media
{
	...
	public class SeekSlider extends Slider implements IMediaPlayerControl
	{
		...
		public function set mediaPlayer(value:IMediaPlayer):void
		{
			...
			if (this._mediaPlayer)
			{
				this._mediaPlayer.removeEventListener(
						MediaPlayerEventType.LOAD_PROGRESS,
						mediaPlayer_loadProgressHandler
				);
				this._mediaPlayer.removeEventListener(
			...
			if (this._mediaPlayer)
			{
				...
				if (this._mediaPlayer is IProgressiveMediaPlayer)
				{
					...
					progressivePlayer.addEventListener(
							MediaPlayerEventType.LOAD_PROGRESS,
							mediaPlayer_loadProgressHandler
					);
		...
		protected function layoutProgressSkin():void
		{
			...
			{
				var trackScrollableHeight:Number = this.actualHeight - this.thumb.height / 2 - this._minimumPadding
